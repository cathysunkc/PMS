        ...
        <asp:Panel ID="panelRegister" runat="server" Visible="false">
            <div class="register-section">
                ...
                Already have an account? Login <asp:LinkButton ID="lbnLogin" CssClass="link" runat="server" OnClick="LoginLink_Click">here</asp:LinkButton>
                 ...
                 <asp:Button runat="server" Text="Register" ID="btnRegister2" CssClass="form-button" OnClick="RegisterSubmit_Click"></asp:Button>



                Already had an account? Login <asp:LinkButton ID="lbnLogin2" CssClass="link" runat="server" OnClick="LoginLink_Click">here</asp:LinkButton>
            </div>
        </asp:Panel>
    </main>
</asp:Content>
