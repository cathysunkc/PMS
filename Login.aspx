    ...
    <main aria-labelledby="title">
        ...
        <asp:Panel ID="panelRegister" runat="server" Visible="false">
            <div class="register-section">
                ...
                <asp:Label ID="lblErrorRegisterFieldsRequired" runat="server" CssClass="error-msg" Text="Please fill out the fields." Visible="false"></asp:Label>
                ...
                <asp:TextBox runat="server" ID="txtRegisterRole" placeholder="Role" CssClass="form-input"></asp:TextBox>
